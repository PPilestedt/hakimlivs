...
(12, 'WD 4TB Gaming Hard Drive', 114, 60.50,
...
(13, 'Acer SB220Q Full HD', 599, 301, '21.5 inches Full HD (1920 x 1080) widescreen IPS display And Radeon free Sync technology.
...
(14, 'Samsung 49-Inch QLED', 999.99, 720, '49 INCH SUPER ULTRAWIDE 32=>9 CURVED GAMING MONITOR with dual 27 inch screen side by side QUANTUM DOT (QLED) TECHNOLOGY, HDR support and factory calibration
...
(15, '3-in-1 Snowboard Jacket', 56.99, 20.50, 'Note: The Jackets is US standard size, Please choose size as your usual wear Material=> 100% Polyester; Detachable Liner Fabric=> Warm Fleece.
...
(16, 'Lock and Love Biker Jacket', 29.95, 10, '100% POLYURETHANE(shell) 100% POLYESTER(lining) 75% POLYESTER 25% COTTON (SWEATER), Faux leather material for style and comfort \/ 2 pockets of front,
...
(17, 'Rain Jacket Windbreaker', 39.99, 20, 'Lightweight perfet for trip or casual wear---Long sleeve with hooded, adjustable drawstring waist design. Button and zipper front closure raincoat,
...
(18, 'MBJ Solid Short Sleeve', 9.85, 2.00, '95% RAYON 5% SPANDEX, Made in USA or Imported, Do Not Bleach,
...
(19, 'Opna Short Sleeve Moisture', 7.95, 4.00, '100% Polyester, Machine wash, 100% cationic polyester interlock, Machine Wash & Pre Shrunk for a Great Fit, Lightweight,
...
(20, 'DANVOUY Womens T-Shirt', 12.99, 6, '95%Cotton,5%Spandex, Features=> Casual, Short Sleeve, Letter Print,V-Neck,Fashion Tees, The fabric is soft and has some stretch.
